...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-166%20passed-success" alt="166 tests">
...
Si responde con el nombre y el número de versión, por ejemplo `TzLang 0.3.1`, ya está instalado.
...
TZ_VERSION=v0.3.1    sh install.sh
```
