...
#
#      curl -fsSL https://github.com/tzerk-last/TzLanguaje/archive/refs/tags/v0.1.0.tar.gz \
#        | shasum -a 256
#
...
class Tzlang < Formula
  ...
  url "https://github.com/tzerk-last/TzLanguaje/archive/refs/tags/v0.1.0.tar.gz"
