...
ARCHIVOS="src/version.h README.md docs/language.md install.sh install.ps1 packaging/homebrew/tzlang.rb packaging/scoop/tzlang.json editors/vscode/package.json editors/vscode/README.md"
