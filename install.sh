...
#
#   TZ_VERSION   version concreta (ej. v0.3.1). Por defecto, la ultima.
...
rojo()  { printf '\033[31m%s\0.3.1m\n' "$1" >&2; }
verde() { printf '\033[32m%s\0.3.1m\n' "$1"; }
info()  { printf '%s\n' "$1"; }
...
Para instalar una version concreta:
    ...
    curl -fsSL https://raw.githubusercontent.com/$REPO/main/install.sh | TZ_VERSION=v0.3.1 sh"
